    ...
    return (
        <>
            ...
            <div className="flex items-center gap-3 mb-3">
                <span className="text-[#d25e2d] font-semibold text-base sm:text-lg">
                    {brandName}
                </span>
            ...
            {/* Название товара */}
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-5 sm:mb-6 text-white">
                {product.name}
            </h1>

            {/* Цена */}
            <div className="flex items-end gap-3 sm:gap-4 mb-6 sm:mb-8">
                <span className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#d25e2d]">

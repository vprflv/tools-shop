...
export default function ProductSpecs({ product }: { product: Product }) {
    return (
        <div className="mb-8 sm:mb-10">
            <h3 className="text-lg sm:text-xl font-semibold mb-5 sm:mb-6 flex items-center gap-2 text-white">
                <Hammer className="w-5 h-5 sm:w-6 sm:h-6 text-[#d25e2d]" />
            ...
            <div className="space-y-3 sm:space-y-4">
                {Object.entries(product.specs || {}).map(([key, value]) => (
                    ...
                    >
                        ...
                        {/* Пунктирная линия */}
                        <div className="flex-1 border-b border-dashed border-[#3a3a3d] relative -top-px hidden sm:block" />

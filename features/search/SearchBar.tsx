    ...
    return (
        <div className={`relative w-full max-w-lg ${className}`}>
            <div className="relative">
                {/* Иконка поиска */}
                <Search className="absolute left-4 sm:left-5 top-1/2 -translate-y-1/2 text-zinc-500 w-5 h-5 sm:w-6 sm:h-6" />
                ...
                <input
                    ...
                    className="w-full
                               ...
                               focus:border-[#d25e2d]
                               focus:ring-2 focus:ring-[#d25e2d]/30
                               rounded-3xl
                               pl-12 sm:pl-14
                               pr-12
                               py-3.5 sm:py-4
                ...
                {localValue && (
                    <button
                        ...
                        className="absolute right-4 sm:right-5 top-1/2 -translate-y-1/2
                                   text-zinc-500 hover:text-[#d25e2d]
